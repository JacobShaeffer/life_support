...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference("Name.count") do
      post names_url, params: { name: { name: @name.name, nameable_id: @name.nameable_id, nameable_type: @name.nameable_type, theme_id: @name.theme_id } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { name: @name.name, nameable_id: @name.nameable_id, nameable_type: @name.nameable_type, theme_id: @name.theme_id } }
